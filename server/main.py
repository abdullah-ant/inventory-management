...
def get_quarterly_reports(
    ...
    # Respect the global filter bar (warehouse/category/status/month) the same
    # way /api/orders and /api/dashboard/summary do, so Reports stays in sync
    # with the rest of the app instead of always showing unfiltered totals.
    filtered_orders = apply_filters(orders, warehouse, category, status)
    filtered_orders = filter_by_month(filtered_orders, month)
...
def get_monthly_trends(
    ...
    # Apply the same global filters as the rest of the app (see quarterly above).
    filtered_orders = apply_filters(orders, warehouse, category, status)
    filtered_orders = filter_by_month(filtered_orders, month)
