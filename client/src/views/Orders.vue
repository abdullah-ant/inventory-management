<template>
  <div class="orders">
    ...
    <div v-else>
      ...
      <!-- Submitted (restocking) orders — only shown after at least one order
           has been placed via the Restocking page.  Rendered above the main
           orders table so they are immediately visible on arrival. -->
          ...
          <table class="orders-table submitted-orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-status">
                  <!-- 'Submitted' maps to the 'info' badge class via the existing
                       getOrderStatusClass fallback (no explicit entry needed). -->
...
/* Submitted orders table uses the same fixed layout as the main table */
